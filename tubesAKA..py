...
class AlgorithmAnalyzer:
    ...
    def analyze_algorithms(self):
        try:
            ...
            results.append(f"Median: {statistics.median([rating[1] for rating in ratings]):.4f}")
            results.append(f"Standard Deviation: {statistics.stdev([rating[1] for rating in ratings]):.4f}")
